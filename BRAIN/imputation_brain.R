#imputation creativity 

# Set working directory
setwd("~/Library/CloudStorage/OneDrive-UniversityCollegeLondon/Desktop/training study data/brain data")
...
measures <- c('CorticalThickness', 'Rputa.frontal_FA', 'Rputa.frontal_MD',
              'Rputa.frontal_RD', 'Rcaud.frontal_FA', 'Rcaud.frontal_MD',
              'Rcaud.frontal_RD', 'HavardOxford_Cortl', 'DMN', 'FPN', 'CON')
...
data.imp <- implist[[1]]
write_csv(data.imp,"BrainMeasures_imputated.csv") #save imputed dataset to use for analyses
