...
setwd("~/Library/CloudStorage/OneDrive-UniversityCollegeLondon/Desktop/training study data/creativity")
...
data_excel<-read_excel("creativity.xlsx")
...
data.imp <- implist[[1]]
write_csv(data.imp,"creativity_imputated.csv") #save imputed dataset to use for analyses
